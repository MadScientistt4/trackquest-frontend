...
const NAV_ITEMS = [
  ...
  { href: '/games/candle-prediction-forex', icon: '💱', label: 'Forex Trading' },
  { href: '/games/stock-prediction', icon: '📈', label: 'Stock Prediction' },
  { href: '/games/crypto-prediction', icon: '🪙', label: 'Crypto Prediction' },
